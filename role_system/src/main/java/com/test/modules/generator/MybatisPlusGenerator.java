package com.test.modules.generator;
 ...
 *
 * @author RenShiWei Date: 2020/7/5 15:16
 */
public class MybatisPlusGenerator {
  ...
  public static void main(String[] args) {
    ...
    strategy
        .setNaming(NamingStrategy.underline_to_camel) // 数据库表映射到实体的命名策略（下划线处理）
        ...
        .setChainModel(true) // 是否为链式模型（默认 false）
